...
import { RekapAngkutRoutes } from './rekap-angkut.routing';
...
@NgModule({
  imports: [
    CommonModule,
    RouterModule.forChild(RekapAngkutRoutes),
  ...
  declarations: [
      ...
      AddComponent,
      EditComponent,
      LookupTimbanganCustomerComponent,
...
export class RekapAngkutModule {}
