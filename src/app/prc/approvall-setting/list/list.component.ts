  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/PrcApprovallSetting/list', dataTablesParameters, {})
          .subscribe(resp => {
...
return nama;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.PrcApprovallSettingService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
        swal({
  ...
  edit(id: number) {
    let that = this;
    let PrcApprovallSetting;
    this.PrcApprovallSettingService.getById(id).subscribe(data => {
      PrcApprovallSetting = data['data'];
  ...
  viewSlip(id) {
    ...
    this.PrcApprovallSettingService.getPdfSlip(id).subscribe(
      (res) => {
        // console.log(res);
