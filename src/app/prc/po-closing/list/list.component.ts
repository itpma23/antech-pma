...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/PrcPo/list', dataTablesParameters, {})
          .subscribe(resp => {
  ...
  closing(id: number) {
    ...
    swal({
      ...
      that.PrcPoService.closing(id, data).subscribe(data => {
        that.rerender();
        swal({
          title: 'Info!',
          text: 'Close PO berhasil.',
          type: 'success',
          confirmButtonClass: "btn btn-success",
          buttonsStyling: false
        })
