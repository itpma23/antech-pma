...
export class EditComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    console.log(this.prcPoTTD);

    // this.entryForm.get('tanggal_efektif').patchValue(new Date(Date.parse(this.prcPoTTD.tanggal_efektif)));
    this.entryForm.controls['tipe'].patchValue(this.prcPoTTD.tipe);
    this.entryForm.controls['nama'].patchValue(this.prcPoTTD.nama);
  ...
  private loadSelect2(): void {
    ...
    //     if (a.id == this.prcPoTTD.lokasi_id) {
    //       selectMill = a;
    //     }
    ...
    //     if (a.id == this.prcPoTTD.supplier_id) {
    //       selectSupplier = a;
    //     }
  ...
  onSubmit() {
    ...
    this.prcPoTTDService.update(this.prcPoTTD.id, dataSubmit).subscribe(data => {
