...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/SlsInvoice/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
            this.slsInvoice = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.slsInvoiceService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
  ...
  edit(id: number) {
    let that = this;
    let slsInvoice;
    this.slsInvoiceService.getById(id).subscribe(data => {
      slsInvoice = data['data'];
  ...
  viewSlip(id) {
    ...
    this.slsInvoiceService.getPdfSlip(id).subscribe(
      (res) => {
        // // console.log(res);
