...
console.log(dataSubmit);
  ...
  hitungTotal(){
    ...
    var jumlah = parseFloat(this.entryForm.get('jumlah').value);
    var harga = parseFloat (this.entryForm.get('harga_satuan').value);
    let sub_total=jumlah*harga;
    this.entryForm.get('sub_total').patchValue(sub_total);
    var disc = parseFloat(this.entryForm.get('disc').value);
    var uang_muka = parseFloat(this.entryForm.get('uang_muka').value);
    var dpp =sub_total-disc-uang_muka;
    var nilai_ppn=parseFloat(this.entryForm.get('ppn').value)/100*dpp;
    var total=sub_total+nilai_ppn;
