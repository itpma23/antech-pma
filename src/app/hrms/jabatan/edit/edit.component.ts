...
import { HrmsJabatan } from 'src/app/shared/models/hrms_jabatan.model';
...
export class EditComponent implements OnInit,AfterViewInit{
  ...
  ngAfterViewInit(): void {
     ...
     this.entryForm.controls['nama'].patchValue(this.jabatan.nama);
  ...
  onSubmit(){
    ...
    this.hrmsJabatanService.update(this.jabatan.id,dataSubmit).subscribe(data=>{
      console.log(data);
      if( data['status']=='OK'){
        console.log('ok');
        this.event.emit('OK');
