...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/HrmsCatuBeras/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.hrmsCatuBerasService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
        swal({
  ...
  edit(id: number) {
    let that = this;
    let hrmsCatuBeras;
    this.hrmsCatuBerasService.getById(id).subscribe(data => {
      hrmsCatuBeras = data['data'];
