...
import { HrmsTipeKaryawan } from 'src/app/shared/models/hrms_tipe_karyawan.model';
...
export class EditComponent implements OnInit,AfterViewInit{
  ...
  tipeKaryawan:HrmsTipeKaryawan;
  dbName;
  pathName;
  PATH_URL;
  constructor(private builder: FormBuilder,
    private bsModalRef: BsModalRef,
    private tipeKaryawanService:HrmsTipeKaryawanService,
  ...
  ngAfterViewInit(): void {
     ...
     this.entryForm.controls['nama'].patchValue(this.tipeKaryawan.nama);
  ...
  onSubmit(){
    ...
    this.tipeKaryawanService.update(this.tipeKaryawan.id,dataSubmit).subscribe(data=>{
      console.log(data);
      if( data['status']=='OK'){
        console.log('ok');
        this.event.emit('OK');
