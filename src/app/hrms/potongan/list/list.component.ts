  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/hrmsPotongan/list', dataTablesParameters, {})
          .subscribe(resp => {
            this.potongan = resp.data;
...
return nama;
  ...
  exportFiles(type) {
    ...
    this.exportAsService.save(this.exportAsConfig, 'potongan').subscribe(() => { });
  }
  add() {
    let modalConfig = {
      animated: true,
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.hrmsPotonganService.delete(id).subscribe(data => {
  ...
  edit(id: number) {
    let that = this;
    let potongan;
    this.hrmsPotonganService.getById(id).subscribe(data => {
      potongan = data['data'];
