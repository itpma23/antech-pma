...
import { HrmsGolongan } from 'src/app/shared/models/hrms_golongan.model';
...
export class EditComponent implements OnInit,AfterViewInit{
  ...
  ngAfterViewInit(): void {
     ...
     this.entryForm.controls['nama'].patchValue(this.golongan.nama);
  ...
  onSubmit(){
    ...
    this.hrmsgolonganService.update(this.golongan.id,dataSubmit).subscribe(data=>{
      console.log(data);
      if( data['status']=='OK'){
        console.log('ok');
        this.event.emit('OK');
