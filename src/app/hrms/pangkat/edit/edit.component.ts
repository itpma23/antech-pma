...
import { HrmsPangkat } from 'src/app/shared/models/hrms_pangkat.model';
...
export class EditComponent implements OnInit,AfterViewInit{
  ...
  ngAfterViewInit(): void {
     ...
     this.entryForm.controls['nama'].patchValue(this.pangkat.nama);
  ...
  onSubmit(){
    ...
    this.hrmspangkatService.update(this.pangkat.id,dataSubmit).subscribe(data=>{
      console.log(data);
      if( data['status']=='OK'){
        console.log('ok');
        this.event.emit('OK');
