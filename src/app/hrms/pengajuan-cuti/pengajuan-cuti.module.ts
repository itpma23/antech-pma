...
import { PengajuanCutiRoutes } from './pengajuan-cuti.routing';
...
@NgModule({
  imports: [
    CommonModule,
    RouterModule.forChild(PengajuanCutiRoutes),
  ...
  declarations: [
    ...
    AddComponent,
    EditComponent,
    LookupPpComponent, ApprovalComponent, UploadComponent,RincianComponent
