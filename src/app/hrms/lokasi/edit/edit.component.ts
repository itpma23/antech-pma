...
import { HrmsLokasi } from 'src/app/shared/models/hrms_lokasi.model';
...
export class EditComponent implements OnInit,AfterViewInit{
  ...
  ngAfterViewInit(): void {
     ...
     this.entryForm.controls['nama'].patchValue(this.lokasi.nama);
  ...
  onSubmit(){
    ...
    this.hrmslokasiService.update(this.lokasi.id,dataSubmit).subscribe(data=>{
      console.log(data);
      if( data['status']=='OK'){
        console.log('ok');
        this.event.emit('OK');
