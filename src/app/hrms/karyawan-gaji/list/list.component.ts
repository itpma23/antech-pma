  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/hrmsKaryawangaji/list', dataTablesParameters, {})
          .subscribe(resp => {
...
return nama;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.hrmsKaryawanGajiService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
        swal({
  ...
  edit(id: number) {
    let that = this;
    let karyawanGaji;
    this.hrmsKaryawanGajiService.getById(id).subscribe(data => {
