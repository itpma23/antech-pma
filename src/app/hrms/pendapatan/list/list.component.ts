...
const MenuName='hrms_pendapatan';
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/hrmsPendapatan/list', dataTablesParameters, {})
          .subscribe(resp => {
            this.pendapatan = resp.data;
...
return nama;
  ...
  exportFiles(type) {
    ...
    this.exportAsService.save(this.exportAsConfig, 'pendapatan').subscribe(() => { });
  }
  add() {
    let modalConfig = {
      animated: true,
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.hrmsPendapatanService.delete(id).subscribe(data => {
  ...
  edit(id: number) {
    let that = this;
    let pendapatan;
    this.hrmsPendapatanService.getById(id).subscribe(data => {
