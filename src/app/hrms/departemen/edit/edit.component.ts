...
import { HrmsDepartemen } from 'src/app/shared/models/hrms_departemen.model';
...
export class EditComponent implements OnInit,AfterViewInit{
  ...
  ngAfterViewInit(): void {
     ...
     this.entryForm.controls['nama'].patchValue(this.departemen.nama);
  ...
  onSubmit(){
    ...
    this.departemenService.update(this.departemen.id,dataSubmit).subscribe(data=>{
      console.log(data);
      if( data['status']=='OK'){
        console.log('ok');
        this.event.emit('OK');
  ...
  updatePhoto(){
    ...
    this.departemenService.updatePhoto(this.departemen.id,frmData).subscribe(data=>{
      console.log(data);
      if( data['status']=='OK'){
        console.log('ok');
        this.event.emit('OK');
