  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/hrmsKomponengaji/list', dataTablesParameters, {})
          .subscribe(resp => {
            this.komponenGaji = resp.data;
...
return nama;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.komponenGajiService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
        swal({
  ...
  edit(id: number) {
    let that = this;
    let komponenGaji;
    this.komponenGajiService.getById(id).subscribe(data => {
      komponenGaji = data['data'];
