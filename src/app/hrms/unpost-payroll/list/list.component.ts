...
export class ListComponent implements OnInit {
  ...
  unposting_gaji(id) {
    let that = this;
    swal({
      title: 'Yakin akan melakukan UnPosting?',
      text: "Posting Gaji",
      type: 'warning',
      showCancelButton: true,
      confirmButtonClass: 'btn btn-success',
      ...
      var currentdate = new Date();
      that.hrmsKaryawanGajiService.startUnPostingGaji(id).subscribe(data => {
        ...
        if (data['status'] == 'OK') {
          ...
          swal({
            title: 'Perhatian!',
            text: 'UnPosting gagal: '+ data['data'],
            type: 'warning',
            confirmButtonClass: "btn btn-success",
            buttonsStyling: false
          })
  ...
  unposting_jamsostek(id) {
    ...
    swal({
      ...
      var currentdate = new Date();
      that.hrmsKaryawanGajiService.startUnPostingJamsostek(id).subscribe(data => {
  ...
  unposting_bpjs_kesehatan(id) {
    ...
    swal({
      ...
      var currentdate = new Date();
      that.hrmsKaryawanGajiService.startUnPostingBpjsKesehatan(id).subscribe(data => {
  ...
  unposting_catu_beras(id) {
    ...
    swal({
      ...
      var currentdate = new Date();
      that.hrmsKaryawanGajiService.startUnPostingCatuBeras(id).subscribe(data => {
