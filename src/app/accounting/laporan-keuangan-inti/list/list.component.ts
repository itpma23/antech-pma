...
export class ListComponent implements OnInit {
  ...
  reportNeracaSaldo() {
    ...
    this.accJurnalService.getLaporanNeracaSaldoInti(dataSubmit).subscribe((res: any) => {
      //console.log(res);
  ...
  reportNeracaSaldoAllUnit() {
    ...
    console.log(dataSubmit);
    this.accJurnalService.getLaporanNeracaSaldoAllUnitInti(dataSubmit).subscribe((res: any) => {
      //console.log(res);
      if (format_laporan == 'xls') {
        let blob = new Blob([res], { type: 'application/vnd.ms-excel' })
  ...
  reportNeraca() {
    ...
    console.log(dataSubmit);
    this.accJurnalService.getLaporanNeracaInti(dataSubmit).subscribe((res: any) => {
      //console.log(res);
  ...
  reportLabaRugi() {
    ...
    // let lokasi_id = this.LabaRugiForm.controls['lokasi'].value['id'] ? this.LabaRugiForm.controls['lokasi'].value['id'] : null;
    ...
    console.log(dataSubmit);
    this.accJurnalService.getLaporanLabaRugiInti(dataSubmit).subscribe((res: any) => {
      //console.log(res);
      if (format_laporan == 'xls') {
        let blob = new Blob([res], { type: 'application/vnd.ms-excel' })
