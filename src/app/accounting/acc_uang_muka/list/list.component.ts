...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/AccUangMuka/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
            this.accUangMuka = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.accUangMukaService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
        swal({
  ...
  edit(id: number) {
    let that = this;
    let accUangMuka;
    this.accUangMukaService.getById(id).subscribe(data => {
      accUangMuka = data['data'];
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.accUangMukaService.posting(id, data).subscribe(data => {
        if (data['status'] == 'OK') {
          that.rerender();
          swal({
            title: 'Info!',
  ...
  viewSlip(id) {
    ...
    this.accUangMukaService.getPdfSlip(id).subscribe(
      (res) => {
        // // console.log(res);
