...
const MenuName = 'acc_kuitansi_pembelian_tbs';
...
export class ListComponent implements OnInit {
  ...
  acc_kuitansi_pembelian_tbs: any[];
  constructor(private http: HttpClient, private authenticationService: AuthenticationService,
    private bsModalService: BsModalService, private exportAsService: ExportAsService,
    private accTbsInvoiceService: AccTbsInvoiceService,
    private accKuitansiPembelianService: AccKuitansiPembelianTbsService,
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      pageLength: 10, // default yang ditampilkan pertama kali
      lengthMenu: [10, 25, 50, 100], // pilihan dropdown jumlah data per halaman
      serverSide: true,
      processing: true,
      order: [[4, "desc"]],
      //responsive: true,
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/AccKuitansiPembelianTbs/list', dataTablesParameters, {})
          .subscribe(resp => {

            this.acc_kuitansi_pembelian_tbs = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.accKuitansiPembelianService.delete(id).subscribe(data => {
  ...
  edit(id: number) {
    let that = this;
    let accKuitansiPembelianTbs;
    this.accKuitansiPembelianService.getById(id).subscribe(data => {
      accKuitansiPembelianTbs = data['data'];
      ...
      let modalConfig = {
        ...
        class: "modal-lg ",
        initialState: {
          accTbsInvoice: accKuitansiPembelianTbs
        }
      };
  ...
  viewSlipInvoice(id) {
    ...
    this.accKuitansiPembelianService.getPdfSlipInvoice(id).subscribe(
      (res) => {
        // console.log(res);
  ...
  viewSlipBa(id) {
    var mediaType = 'application/pdf';
    this.accKuitansiPembelianService.getPdfSlipBA(id).subscribe(
      (res) => {
        // console.log(res);
        var fileURL = URL.createObjectURL(res);
        window.open(fileURL);
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.accKuitansiPembelianService.posting(id, data).subscribe(data => {
