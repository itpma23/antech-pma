...
import { AccKegiatanKelompok } from 'src/app/shared/models/acc_kegiatan_kelompok.model';
...
export class EditComponent implements OnInit, AfterViewInit {
  ...
  accKegiatanKelompok: AccKegiatanKelompok;
  dbName;
  pathName;
  PATH_URL;
  ...
  ngAfterViewInit(): void {
    console.log(this.accKegiatanKelompok);

    // this.entryForm.get('tanggal_efektif').patchValue(new Date(Date.parse(this.accKegiatanKelompok.tanggal_efektif)));
    this.entryForm.controls['kode'].patchValue(this.accKegiatanKelompok.kode);
    this.entryForm.controls['nama'].patchValue(this.accKegiatanKelompok.nama);
  ...
  private loadSelect2(): void {
    ...
    //     if (a.id == this.accKegiatanKelompok.lokasi_id) {
    //       selectMill = a;
    //     }
    ...
    //     if (a.id == this.accKegiatanKelompok.supplier_id) {
    //       selectSupplier = a;
    //     }
  ...
  onSubmit() {
    ...
    this.accKegiatanKelompokService.update(this.accKegiatanKelompok.id, dataSubmit).subscribe(data => {
