...
@Component({
  moduleId: module.id,
  selector: 'lookup-invoice-angkut-cpo-cmp',
  templateUrl: 'lookup-invoice-angkut-cpo.component.html'
})

export class LookupInvoiceAngkutCpoComponent implements OnInit {
