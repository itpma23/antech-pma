...
declare var $: any;
const MenuName = 'acc_jurnal_entry';
@Component({
  moduleId: module.id,
  selector: 'list-cmp',
...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/accJurnalEntry/list', dataTablesParameters, {})
          .subscribe(resp => {

            this.accJurnal = resp.data;
  ...
  viewSlip(id) {
    ...
    this.accJurnalService.getPdfSlip(id).subscribe(
      (res) => {
        // // console.log(res);
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.accJurnalService.delete(id).subscribe(data => {
  ...
  edit(id: number) {
    let that = this;
    let accJurnal;
    this.accJurnalService.getById(id).subscribe(data => {
      accJurnal = data['data'];
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.accJurnalService.posting(id, data).subscribe(data => {
        if (data['status'] == 'OK') {
