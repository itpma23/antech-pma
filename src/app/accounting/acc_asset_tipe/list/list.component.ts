...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/AccAssetTipe/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
            this.accAssetTipe = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.accAssetTipeService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
  ...
  edit(id: number) {
    let that = this;
    let accAssetTipe;
    this.accAssetTipeService.getById(id).subscribe(data => {
      accAssetTipe = data['data'];
