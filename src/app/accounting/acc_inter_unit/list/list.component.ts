...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/AccInterUnit/list', dataTablesParameters, {})
          .subscribe(resp => {
            this.AccInterUnit = resp.data;
  ...
  exportFiles(type) {
    ...
    this.exportAsService.save(this.exportAsConfig, 'AccInterUnit').subscribe(() => { });
  }
  add() {
    let modalConfig = {
      animated: true,
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.AccInterUnitService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
        swal({
  ...
  edit(id: number) {
    let that = this;
    let AccInterUnit;
    this.AccInterUnitService.getById(id).subscribe(data => {
      AccInterUnit = data['data'];
  ...
  detail(id: number) {
    this.router.navigate(['AccInterUnit/detail', id.toString(), { previousUrl: this.router.url }]);
