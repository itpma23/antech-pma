...
export class ListComponent implements OnInit {
  ...
  reportApRincian() {
    ...
    let format_laporan = this.laporanRincianAp.controls['format_laporan'].value;
    let versi_laporan = this.laporanRincianAp.controls['versi_laporan'].value;
    let lokasi_id = (this.laporanRincianAp.controls['lokasi'].value != null) ? this.laporanRincianAp.controls['lokasi'].value['id'] : null;
    let supplier_id = (this.laporanRincianAp.controls['supplier'].value != null) ? this.laporanRincianAp.controls['supplier'].value['id'] : null;
    let data = {
    ...
    console.log(data);
    this.accTbsInvoiceService.getTbsInvoiceReport(data).subscribe((res: any) => {
      if (format_laporan == 'xls') {
        let blob = new Blob([res], { type: 'application/vnd.ms-excel' })
        saveAs(blob, 'laporan_ap.xls')
