...
export class ListComponent implements OnInit {
  ...
  dataSelectTipe: { id: number; text: string; }[];
  ...
  reportPoRincian(tipe_laporan) {
    ...
    let asset_tipe_id = (this.laporanRincianPo.controls['asset_tipe_id'].value != null) ? this.laporanRincianPo.controls['asset_tipe_id'].value['id'] : null;
    ...
    console.log(data);
    this.accAssetService.getPoReportDetail(data).subscribe((res: any) => {
