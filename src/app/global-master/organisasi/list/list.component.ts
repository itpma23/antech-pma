...
export class ListComponent implements OnInit {
  ...
  refreshData(){
    this.GbmOrganisasiService.getAllHirarki().subscribe(d => {
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.GbmOrganisasiService.delete(id).subscribe(data => {
        that.refreshData();
  ...
  edit(id: number) {
    let that = this;
    let organisasi;
    this.GbmOrganisasiService.getById(id).subscribe(data => {
      organisasi = data['data'];
