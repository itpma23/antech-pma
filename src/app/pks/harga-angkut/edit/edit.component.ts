...
import { PksHargaAngkut } from 'src/app/shared/models/pks_harga_angkut.model';
import { GbmOrganisasiService } from 'src/app/shared/services/gbm_organisasi.service';
import { PksHargaAngkutService } from 'src/app/shared/services/pks_harga_angkut.service';
...
export class EditComponent implements OnInit, AfterViewInit {
  ...
  pksHargaAngkut: PksHargaAngkut;
  dbName;
  pathName;
  PATH_URL;
  constructor(private builder: FormBuilder,
    private bsModalRef: BsModalRef,
    private pksHargaAngkutService: PksHargaAngkutService,
  ...
  ngAfterViewInit(): void {
    console.log(this.pksHargaAngkut);

    this.entryForm.get('tanggal_efektif').patchValue(new Date(Date.parse(this.pksHargaAngkut.tanggal_efektif)));
    this.entryForm.controls['harga'].patchValue(this.pksHargaAngkut.harga);
  ...
  private loadSelect2(): void {
    ...
    //     if (a.id == this.pksHargaAngkut.lokasi_id) {
    //       selectMill = a;
    //     }
    ...
    this.gbmSupplierService.getAll().subscribe(x => {
      ...
      this.dataSelectSupplier.forEach(a => {
        if (a.id == this.pksHargaAngkut.supplier_id) {
          selectSupplier = a;
        }
  ...
  onSubmit() {
    ...
    this.pksHargaAngkutService.update(this.pksHargaAngkut.id, dataSubmit).subscribe(data => {
