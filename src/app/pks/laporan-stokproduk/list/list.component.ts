...
import { PksStokProdukService } from 'src/app/shared/services/pks_stokproduk.service';
...
export class ListComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private authenticationService: AuthenticationService,
    ...
    private pksStokProdukService: PksStokProdukService,
    ...
    this.StokProdukForm = this.builder.group({
      lokasi: new FormControl([], Validators.required),
  ...
  reportProduksi() {
    ...
    let produk_id = (this.StokProdukForm.controls['produk'].value!=null)?this.StokProdukForm.controls['produk'].value['id']:null ;
    ...
    this.pksStokProdukService.getLaporanStokProduk(data).subscribe((res:any) => {
      //console.log(res);
  ...
  reportStokProduk() {
    this.isFormProduksiSubmitted = true;
    if (this.StokProdukForm.invalid) {
      return;
    }
    let produk_id = (this.StokProdukForm.controls['produk'].value!=null)?this.StokProdukForm.controls['produk'].value['id']:null ;

    let lokasi_id = (this.StokProdukForm.controls['lokasi'].value!=null)?this.StokProdukForm.controls['lokasi'].value['id']:null ;
    let data={
     mill_id: lokasi_id,
     produk_id: produk_id,
      tgl_mulai: formatDate(this.StokProdukForm.controls['tanggal_mulai'].value, "yyyy-MM-dd", 'en_US'),
      tgl_akhir: formatDate(this.StokProdukForm.controls['tanggal_akhir'].value, "yyyy-MM-dd", 'en_US'),
    };
