...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/PksLab/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
            this.pksLab = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.pksLabService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
        swal({
  ...
  edit(id: number) {
    let that = this;
    let pksLab;
    this.pksLabService.getById(id).subscribe(data => {
      pksLab = data['data'];
