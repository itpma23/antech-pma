...
import { PksJenisMaintenance } from 'src/app/shared/models/pks_jenis_maintenance';
...
export class EditComponent implements OnInit, AfterViewInit {
  ...
  pksJenisMaintenance: PksJenisMaintenance;
  dbName;
  pathName;
  PATH_URL;
  ...
  ngAfterViewInit(): void {
    console.log(this.pksJenisMaintenance);

    // this.entryForm.get('tanggal_efektif').patchValue(new Date(Date.parse(this.pksJenisMaintenance.tanggal_efektif)));
    this.entryForm.controls['kode'].patchValue(this.pksJenisMaintenance.kode);
    this.entryForm.controls['keterangan'].patchValue(this.pksJenisMaintenance.keterangan);
  ...
  private loadSelect2(): void {
    ...
    //     if (a.id == this.pksJenisMaintenance.lokasi_id) {
    //       selectMill = a;
    //     }
    ...
    //     if (a.id == this.pksJenisMaintenance.supplier_id) {
    //       selectSupplier = a;
    //     }
  ...
  onSubmit() {
    ...
    this.pksJenisMaintenanceService.update(this.pksJenisMaintenance.id, dataSubmit).subscribe(data => {
