...
return nama;
  ...
  edit(id: number) {
    let that = this;
    let PksSjpp;
    this.PksSjppService.getById(id).subscribe(data => {
      PksSjpp = data['data'];
  ...
  viewSlip(id) {
    ...
    this.PksSjppService.getPdfSlip(id).subscribe(
      (res) => {
        // // console.log(res);
  ...
  print_cpo(id) {
    var mediaType = 'application/pdf';
    this.PksSjppService.getPdfCpo(id).subscribe(
      (res) => {
        // // console.log(res);
        var fileURL = URL.createObjectURL(res);
        window.open(fileURL);
  ...
  print_kernel(id) {
    var mediaType = 'application/pdf';
    this.PksSjppService.getPdfKernel(id).subscribe(
      (res) => {
        // // console.log(res);
        var fileURL = URL.createObjectURL(res);
        window.open(fileURL);
