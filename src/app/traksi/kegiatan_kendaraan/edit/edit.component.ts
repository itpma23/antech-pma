...
export class EditComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    this.entryForm.get('no_transaksi').patchValue(this.trkKegiatanKendaraan.no_transaksi);
  ...
  onSubmit() {
    ...
    console.log(frmData);
    this.trkKegiatanKendaraanService.update(this.trkKegiatanKendaraan.id, frmData).subscribe(data => {
      // console.log(data);
      if (data['status'] == 'OK') {
        console.log('ok');
        swal({
