...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/TrkKendaraan/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
            this.trkKendaraan = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.trkKendaraanService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
  ...
  edit(id: number) {
    let that = this;
    let trkKendaraan;
    this.trkKendaraanService.getById(id).subscribe(data => {
      trkKendaraan = data['data'];
