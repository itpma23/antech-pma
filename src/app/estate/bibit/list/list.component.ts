...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/EstBibit/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
            this.estBibit = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.estBibitService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
        swal({
  ...
  edit(id: number) {
    let that = this;
    let estBibit;
    this.estBibitService.getById(id).subscribe(data => {
      estBibit = data['data'];
