...
const MenuName = 'est_rekap_panen';
...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/estRekappanen/list', dataTablesParameters, {})
          .subscribe(resp => {
            this.rekap_panen = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.estRekapPanenService.delete(id).subscribe(data => {
  ...
  edit(id: number) {
    let that = this;
    let estRekapPanen;
    this.estRekapPanenService.getById(id).subscribe(data => {
  ...
  viewSlip(id) {
    ...
    this.estRekapPanenService.getPdfSlip(id).subscribe(
      (res) => {
        // console.log(res);
