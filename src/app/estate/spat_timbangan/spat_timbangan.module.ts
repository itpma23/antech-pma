...
import { SpatTimbanganRoutes } from './spat_timbangan.routing';
...
@NgModule({
  imports: [
    CommonModule,
    RouterModule.forChild(SpatTimbanganRoutes),
...
export class SpatTimbanganModule {}
