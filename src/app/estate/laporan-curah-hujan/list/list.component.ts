...
const MenuName = 'laporan-curah-hujan';
declare var $: any;
...
export class ListComponent implements OnInit {
  ...
  reportPoRincian(tipe_laporan) {
    ...
    let afdeling_id = (this.laporanRincianPo.controls['afdeling'].value != null) ? this.laporanRincianPo.controls['afdeling'].value['id'] : null;
    ...
    console.log(data);
    this.EstCurahHujanService.getReportDetail(data).subscribe((res: any) => {
      if (format_laporan == 'xls') {
        let blob = new Blob([res], { type: 'application/vnd.ms-excel' })
        saveAs(blob, 'rincian_pindah_gudang.xls')
      } else {
