...
export class CopyComponent implements OnInit, AfterViewInit {
            ...
            this.estKodeDendaPanenService.getAll().subscribe(x => {
              ...
              for (let index = 0; index < dtl.length; index++) {
                ...
                this.addDetailEdit(d.blok_id, d.karyawan_id, d.hasil_kerja_jjg, d.hasil_kerja_brondolan, d.hasil_kerja_luas,
                  ...
                  d.premi_panen, d.denda_panen, d.denda_basis, d.basis_jjg, d.total_pendapatan, d.bjr, d.jumlah_hk, d.ket, d.potongan, d.keterangan_potongan, d.denda);
              }
            });
          });
  ...
  addDetailEdit(blok_id, karyawan_id, hasil_kerja_jjg, hasil_kerja_brondolan,
    ...
    premi_panen, denda_panen, denda_basis, basis_jjg, total_pendapatan, bjr, jumlah_hk, ket, potongan, keterangan_potongan, arr_denda) {
  ...
  addDetail() {
    ...
    this.details.push(this.builder.group({
      ...
      // kegiatan_id: new FormControl([], Validators.required),
      bjr: new FormControl({ value: 0, disabled: true }, Validators.required),
      ...
      basis_jjg: new FormControl({ value: 0, disabled: true }, Validators.required),
