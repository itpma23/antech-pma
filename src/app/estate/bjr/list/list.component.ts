...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/EstBjr/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
            this.estBjr = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.estBjrService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
        swal({
  ...
  edit(id: number) {
    let that = this;
    let estBjr;
    this.estBjrService.getById(id).subscribe(data => {
      estBjr = data['data'];
