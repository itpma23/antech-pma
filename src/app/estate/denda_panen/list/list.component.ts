...
const MenuName = 'est_denda_panen';
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/estDendaPanen/list', dataTablesParameters, {})
          .subscribe(resp => {
            this.dendaPanen = resp.data;
...
return nama;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.estDendaPanenService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
        swal({
  ...
  edit(id: number) {
    let that = this;
    let dendaPanen;
    this.estDendaPanenService.getById(id).subscribe(data => {
      dendaPanen = data['data'];
