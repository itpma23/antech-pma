...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/EstTaksasi/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
            this.estTaksasi = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.estTaksasiService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
  ...
  edit(id: number) {
    let that = this;
    let estTaksasi;
    this.estTaksasiService.getById(id).subscribe(data => {
      estTaksasi = data['data'];
