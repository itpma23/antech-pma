...
export class ListComponent implements OnInit {
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.EstSpkBAService.delete(id).subscribe(data => {
        that.rerender();
        swal({
          title: 'Deleted!',
  ...
  edit(id: number) {
    let that = this;
    let EstSpkBA;
    this.EstSpkBAService.getById(id).subscribe(data => {
      EstSpkBA = data['data'];
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.EstSpkBAService.posting(id, data).subscribe(data => {
        // that.rerender();
        // swal({
        //   title: 'Info!',
  ...
  viewSlip(id) {
    ...
    this.EstSpkBAService.getPdfSlip(id).subscribe(
      (res) => {
        // console.log(res);
