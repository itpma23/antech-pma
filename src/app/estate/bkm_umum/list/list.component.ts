...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/estBkmUmum/list', dataTablesParameters, {})
          .subscribe(resp => {
            this.estBkmUmum = resp.data;
  ...
  ListDetail() {
    ...
    console.log(parameter);
    this.estBkmUmumService.listBkmUmumDetail(parameter).subscribe((res: any) => {
      if (format_laporan == 'xls') {
        console.log(res);
        let blob = new Blob([res], { type: 'application/vnd.ms-excel' })
        saveAs(blob, 'list_Umum.xls')
      } else {
  ...
  exportExcel() {
    ...
    this.estBkmUmumService.listBkmUmum(parameter).subscribe((res: any) => {
      if (format_laporan == 'xls') {
        console.log(res);
        let blob = new Blob([res], { type: 'application/vnd.ms-excel' })
        saveAs(blob, 'list_umum.xls')
  ...
  exportFiles(type) {
    ...
    this.exportAsService.save(this.exportAsConfig, 'bkm').subscribe(() => { });
  }
  add() {
    let modalConfig = {
      animated: true,
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.estBkmUmumService.delete(id).subscribe(data => {
  ...
  edit(id: number) {
    let that = this;
    let estBkmUmum;
    this.estBkmUmumService.getById(id).subscribe(data => {
      estBkmUmum = data['data'];
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.estBkmUmumService.posting(id, data).subscribe(data => {
  ...
  viewSlip(id) {
    ...
    this.estBkmUmumService.getPdfSlip(id).subscribe(
      (res) => {
        // console.log(res);
        var fileURL = URL.createObjectURL(res);
        window.open(fileURL);
