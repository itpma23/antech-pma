...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/UserActivity/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
            this.userActivity = resp.data;
  ...
  exportFiles(type) {
    ...
    this.exportAsService.save(this.exportAsConfig, 'activity').subscribe(() => { });
  }
  ...
  clearData() {
    ...
    swal({
      ...
      that.userAccesService.deleteActivityUserAll().subscribe((resp) => {
        swal({
          title: 'Info!',
