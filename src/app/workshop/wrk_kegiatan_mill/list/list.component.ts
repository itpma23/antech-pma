...
const MenuName = 'work_kegiatan_mill';
...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/WrkKegiatanMill/list', dataTablesParameters, {})
          .subscribe(resp => {
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.WrkKegiatanMillService.delete(id).subscribe(data => {
         swal({
        title: 'Deleted!',
  ...
  edit(id: number) {
    let that = this;
    let WrkKegiatan;
    this.WrkKegiatanMillService.getById(id).subscribe(data => {
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.WrkKegiatanMillService.posting(id, data).subscribe(data => {
        that.rerender();
        swal({
          title: 'Info!',
  ...
  viewSlip(id) {
    ...
    this.WrkKegiatanMillService.getPdfSlip(id).subscribe(
      (res) => {
        // console.log(res);
