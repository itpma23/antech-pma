...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/InvPermintaanBarang/list', dataTablesParameters, {})
          .subscribe(resp => {

            this.invPermintaanBarang = resp.data;
  ...
  rerender(): void {
    this.dtElement.dtInstance.then((dtInstance: DataTables.Api) => {
      ...
      setTimeout(() => {
        ...
        if (this.invPermintaanBarang.length > 0) {
  ...
  viewSlip(id) {
    ...
    this.invPermintaanBarangService.getPdfSlip(id).subscribe(
      (res) => {
        // // console.log(res);
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.invPermintaanBarangService.delete(id).subscribe(data => {
  ...
  edit(id: number) {
    let that = this;
    let invPermintaanBarang;
    this.invPermintaanBarangService.getById(id).subscribe(data => {
      invPermintaanBarang = data['data'];
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.invPermintaanBarangService.posting(id, data).subscribe(data => {
