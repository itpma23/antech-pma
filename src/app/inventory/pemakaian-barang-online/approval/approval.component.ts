...
export class ApprovalComponent implements OnInit,AfterViewInit{
   isFormSubmitted=false;
    ...
    constructor(private builder: FormBuilder,
      ...
      private invApprovalSettingService: InvApprovalSettingPbService,
    ...
    private loadSelect2(): void {
      ...
      console.log('blok =>',this.addBlok)
  
      this.invApprovalSettingService.getKaryawanByLokasiAndKode(this.InvPemakaianBarang.lokasi_id,"PB1", 1).subscribe(p=>{
    ...
    ngOnInit() {
      ...
      console.log('ID INVPEMAKAIANBARANG',this.InvPemakaianBarang.id)
