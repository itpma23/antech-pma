...
declare var $: any;
const MenuName = 'inv_penerimaan_tanpa_po';
@Component({
  moduleId: module.id,
  selector: 'list-cmp',
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/InvPenerimaanTanpaPo/list', dataTablesParameters, {})
          .subscribe(resp => {
            // console.log(resp.data);
            this.InvPenerimaanTanpaPo = resp.data;
...
return nama;
  ...
  rerender(): void {
    this.dtElement.dtInstance.then((dtInstance: DataTables.Api) => {
      ...
      setTimeout(() => {
        ...
        if (this.InvPenerimaanTanpaPo.length > 0) {
  ...
  exportFiles(type) {
    ...
    this.exportAsService.save(this.exportAsConfig, 'InvPenerimaanTanpaPo').subscribe(() => { });
  }
  add() {
    let modalConfig = {
      animated: true,
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.InvPenerimaanTanpaPoService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
  ...
  edit(id: number) {
    let that = this;
    let InvPenerimaanTanpaPo;
    this.InvPenerimaanTanpaPoService.getById(id).subscribe(data => {
      InvPenerimaanTanpaPo = data['data'];
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.InvPenerimaanTanpaPoService.posting(id, data).subscribe(data => {
  ...
  viewSlip(id) {
    ...
    this.InvPenerimaanTanpaPoService.getPdfSlip(id).subscribe(
      (res) => {
        // console.log(res);
  ...
  detail(id: number) {
    this.router.navigate(['InvPenerimaanTanpaPo/detail', id.toString(),{previousUrl: this.router.url}]);
