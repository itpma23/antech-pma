...
export class UploadComponent implements OnInit, AfterViewInit {
 ...
 PATH_URL;
  ...
  ngAfterViewInit(): void {
    ...
    // this.entryForm.controls['no_invPenerimaanPo'].patchValue(this.invPenerimaanPo.no_invPenerimaanPo);
    // this.entryForm.controls['no_referensi'].patchValue(this.invPenerimaanPo.no_referensi);
    // this.entryForm.controls['catatan'].patchValue(this.invPenerimaanPo.catatan);
  ...
  onSubmit() {
    ...
    this.invPenerimaanPoService.upload(this.invPenerimaanPo.id, frmData).subscribe(data => {
     console.log(data)
      if (data['status'] == 'OK') {
        swal({
          title: 'Info!',
  ...
  updatePhoto() {
    ...
    this.invPenerimaanPoService.updatePhoto(this.invPenerimaanPo.id, frmData).subscribe(data => {
      console.log(data);
      if (data['status'] == 'OK') {
        console.log('ok');
        this.event.emit('OK');
