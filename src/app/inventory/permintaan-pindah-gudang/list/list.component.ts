...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/InvPermintaanPindahGudang/list', dataTablesParameters, {})
          .subscribe(resp => {

            this.InvPermintaanPindahGudang = resp.data;
  ...
  rerender(): void {
    this.dtElement.dtInstance.then((dtInstance: DataTables.Api) => {
      ...
      setTimeout(() => {
        ...
        if (this.InvPermintaanPindahGudang.length > 0) {
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.InvPermintaanPindahGudangService.delete(id).subscribe(data => {
  ...
  edit(id: number) {
    let that = this;
    let InvPermintaanPindahGudang;
    this.InvPermintaanPindahGudangService.getById(id).subscribe(data => {
      InvPermintaanPindahGudang = data['data'];
      console.log(InvPermintaanPindahGudang);
      let modalConfig = {
        animated: true,
        keyboard: true,
        backdrop: true,
  ...
  viewSlip(id) {
    ...
    this.InvPermintaanPindahGudangService.getPdfSlip(id).subscribe(
      (res) => {
        // // console.log(res);
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.InvPermintaanPindahGudangService.posting(id, data).subscribe(data => {
