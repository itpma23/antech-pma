...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/invItem/list', dataTablesParameters, {})
          .subscribe(resp => {
            this.item = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.invItemService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
        swal({
  ...
  edit(id: number) {
    let that = this;
    let item;
    this.invItemService.getById(id).subscribe(data => {
      item = data['data'];
  ...
  import() {
    ...
    this.bsModalRef.content.event.subscribe((result: any) => {
      ...
      if (result === 'OK') {
        ...
        this.rerender(); // reload datatable
