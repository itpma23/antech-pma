...
export class ListComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private authenticationService: AuthenticationService,
    ...
    private invPenerimaanPoService: InvPenerimaanPoService,
  ...
  reportPoRincian(tipe_laporan) {
    ...
    let data = {
      ...
      no_po: this.laporanRincianPo.controls['no_po'].value,
      lokasi_id: lokasi_id,
    ...
    console.log(data);
    this.invPenerimaanPoService.getPoReportDetail(data).subscribe((res: any) => {
      if (format_laporan == 'xls') {
        let blob = new Blob([res], { type: 'application/vnd.ms-excel' })
        saveAs(blob, 'rincian_penerimaan_po.xls')
      } else {
