...
export class ListComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private authenticationService: AuthenticationService,
    ...
    this.kartuStokForm = this.builder.group({
      ...
      tanggal_akhir: new FormControl(toDate, Validators.required),
      format_laporan: new FormControl('view', Validators.required),
      jenis_laporan: new FormControl('by_item', Validators.required),
    });
  ...
  reportRekapStok() {
    ...
    this.invLaporanService.getLaporanRekapSaldo(dataSubmit).subscribe((res:any) => {
  ...
  reportKartuStok() {
    ...
    let kategori_id = this.kartuStokForm.controls['kategori'].value['id'] ? this.kartuStokForm.controls['kategori'].value['id'] : null;
    ...
    let jenis_laporan=this.kartuStokForm.controls['jenis_laporan'].value;
    dataSubmit = {
      'format_laporan': format_laporan,
     ...
     console.log(dataSubmit);
    this.invLaporanService.getLaporanKartuStok(dataSubmit).subscribe((res:any) => {
      if (format_laporan == 'xls') {
        let blob = new Blob([res], { type: 'application/vnd.ms-excel' })
        saveAs(blob, 'stok.xls')
      } else {
