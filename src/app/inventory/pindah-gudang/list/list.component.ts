...
declare var $: any;
const MenuName = 'inv_pindah_gudang';
@Component({
  moduleId: module.id,
  selector: 'list-cmp',
...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/InvPindahGudang/list', dataTablesParameters, {})
          .subscribe(resp => {

            this.invPindahGudang = resp.data;
  ...
  rerender(): void {
    this.dtElement.dtInstance.then((dtInstance: DataTables.Api) => {
      ...
      setTimeout(() => {
        ...
        if (this.invPindahGudang.length > 0) {
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.invPindahGudangService.delete(id).subscribe(data => {
  ...
  edit(id: number) {
    let that = this;
    let invPindahGudang;
    this.invPindahGudangService.getById(id).subscribe(data => {
      invPindahGudang = data['data'];
  ...
  viewSlip(id) {
    ...
    this.invPindahGudangService.getPdfSlip(id).subscribe(
      (res) => {
        // // console.log(res);
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.invPindahGudangService.posting(id, data).subscribe(data => {
