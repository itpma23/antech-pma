  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/invKategori/list', dataTablesParameters, {})
          .subscribe(resp => {
...
return nama;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.kategoriService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
  ...
  edit(id: number) {
    let that = this;
    let akun;
    this.kategoriService.getById(id).subscribe(data => {
      akun = data['data'];
