...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/BgtProduksi/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
            this.bgtProduksi = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.bgtProduksiService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
        swal({
  ...
  edit(id: number) {
    let that = this;
    let bgtProduksi;
    this.bgtProduksiService.getById(id).subscribe(data => {
      bgtProduksi = data['data'];
