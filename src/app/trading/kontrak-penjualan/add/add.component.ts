...
export class AddComponent implements OnInit, AfterViewInit {
  ...
  constructor(private builder: FormBuilder,
    ...
    private pksTimbanganService: TradingKontrakService,
 ...
 ngAfterViewInit(): void {
  ...
  //     if (!window['DocsAPI']) {
  //       console.error('DocsAPI tidak ditemukan');
  //       return;
  //     }
  ...
  //         document: {
  //           title: 'Kontrak Trading.docx',
  //           fileType: 'docx',
  //           key: 'kontrak-trading-test-001',
  //           url: 'https://erp.dpa-agri.com/test/kontrak.docx'
  //         },
  ...
  //         token: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..GOGcyk1bZqbXbDKXirFctflwo-U7KIGp7Ho4WKYp-Ok'
  //       }
  //     );
