...
const MenuName = 'trading_kontrak';
...
export class ListComponent implements OnInit {
  ...
  dataSelectItem: any;
  parameterForm: any;
  monitoringBelumInvoice:any;
  monitoringInvoice:any;
  accessButton: any;

  constructor(private http: HttpClient, private authenticationService: AuthenticationService,
    private bsModalService: BsModalService, private exportAsService: ExportAsService,
    private pksKontrakService: TradingKontrakService,
    ...
    this.dtOptions = {
      ...
      columns: [
...

        {
          ...
          {
    data: 'is_closing'   // <-- Status Closing
  },
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/TradingKontrak/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
...
closing(id: number): void {
  ...
  swal({
    title: 'Closing Kontrak?',
    text: 'Setelah kontrak di Closing maka data tidak dapat diedit kembali.',
    type: 'warning',
    showCancelButton: true,
    ...
    swal({
      title: 'Mohon Tunggu',
      text: 'Sedang melakukan Closing Kontrak...',
