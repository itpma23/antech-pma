...
declare var $: any;
const MenuName = 'inv_penerimaan_po';
@Component({
  moduleId: module.id,
  selector: 'list-cmp',
...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/InvPenerimaanPoTrading/list', dataTablesParameters, {})
          .subscribe(resp => {

            this.invPenerimaanPo = resp.data;
  ...
  rerender(): void {
    this.dtElement.dtInstance.then((dtInstance: DataTables.Api) => {
      ...
      setTimeout(() => {
        ...
        if (this.invPenerimaanPo.length > 0) {
  ...
  viewSlip(id) {
    ...
    this.invPenerimaanPoService.getPdfSlip(id).subscribe(
      (res) => {
        // console.log(res);
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.invPenerimaanPoService.delete(id).subscribe(data => {
  ...
  edit(id: number) {
    let that = this;
    let invPenerimaanPo;
    this.invPenerimaanPoService.getById(id).subscribe(data => {
      invPenerimaanPo = data['data'];
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.invPenerimaanPoService.posting(id, data).subscribe(data => {
  ...
  download(id) {
    this.invPenerimaanPoService.getById(id).subscribe(data => {
     ...
     this.invPenerimaanPoService.download(id, filename);
    });
  }
}
