...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/TradingPr/list', dataTablesParameters, {})
          .subscribe(resp => {

            this.PrcPp = resp.data;
  ...
  statusApproval(id: number) {
    ...
    this.PrcPpService.getById(id).subscribe(data => {
      ...
      this.bsModalRef = this.bsModalService.show(TradingPpStatusApprovalComponent, modalConfig);
  ...
  closing(id: number) {
    ...
    let data;
    swal({
      title: 'Yakin akan Close PP?',
      text: "Data tidak bisa akan dapat diubah !",
      type: 'warning',
      showCancelButton: true,
      confirmButtonClass: 'btn btn-success',
      cancelButtonClass: 'btn btn-danger',
      confirmButtonText: 'Ya, Closing data!',
      cancelButtonText: 'Batal',

      buttonsStyling: false
    }).then(function () {
      that.PrcPpService.closing(id, data).subscribe(data => {
        that.rerender();
        swal({
          title: 'Info!',
          text: 'Closing PP berhasil.',
          type: 'success',
          confirmButtonClass: "btn btn-success",
          buttonsStyling: false
        })
