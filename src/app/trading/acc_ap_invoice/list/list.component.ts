...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/TradingApInvoice/list', dataTablesParameters, {})
          .subscribe(resp => {

            this.accApInvoice = resp.data;
  ...
  viewSlip(id) {
    ...
    this.accApInvoiceService.getPdfSlip(id).subscribe(
      (res) => {
        // // console.log(res);
  ...
  viewSlip2(id) {
    var mediaType = 'application/pdf';
    this.accApInvoiceService.getPdfSlip2(id).subscribe(
      (res) => {
        // // console.log(res);
        var fileURL = URL.createObjectURL(res);
        window.open(fileURL);
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.accApInvoiceService.delete(id).subscribe(data => {
  ...
  edit(id: number) {
    let that = this;
    let accApInvoice;
    this.accApInvoiceService.getById(id).subscribe(data => {
      accApInvoice = data['data'];
  ...
  faktur(id: number) {
    ...
    this.accApInvoiceService.getById(id).subscribe(data => {
      ...
      this.bsModalRef = this.bsModalService.show(FakturComponent, modalConfig);
      this.bsModalRef.content.event.subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.accApInvoiceService.posting(id, data).subscribe(data => {
  ...
  OutStandingFakturPajak() {
    var mediaType = 'application/pdf';
    this.accApInvoiceService.OutStandingFakturPajak().subscribe(
      (res) => {
        // // console.log(res);
        var fileURL = URL.createObjectURL(res);
        window.open(fileURL);
  ...
  download(id: number) {
    ...
    this.accApInvoiceService.getById(id).subscribe(data => {
      ...
      this.bsModalRef = this.bsModalService.show(DownloadComponent, modalConfig);
      this.bsModalRef.content.event.subscribe(data => {
