...
@Component({
  moduleId: module.id,
  selector: 'pp-approval_po-cmp',
  styleUrls: ['approval_po.component.css'],
  templateUrl: 'approval_po.component.html'
})

export class ApprovalPoComponent implements OnInit,AfterViewInit{
