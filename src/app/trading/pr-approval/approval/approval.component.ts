...
export class ApprovalComponent implements OnInit, AfterViewInit {
  ...
  private loadSelect2(): void {
    ...
    let next_kode_pp = '';
    if (this.PrcPp.last_approve_position == 'PP1') {
      next_kode_pp = 'PP2'
    } else if (this.PrcPp.last_approve_position == 'PP2') {
      next_kode_pp = 'PP3'
    } if (this.PrcPp.last_approve_position == 'PP3') {
      next_kode_pp = 'PP4'
    } if (this.PrcPp.last_approve_position == 'PP4') {
      next_kode_pp = 'PP5'
    } if (this.PrcPp.last_approve_position == 'PP5') {
      next_kode_pp = 'PP6'
    }
    this.prcApprovallSettingService.getKaryawanByLokasiAndKode(this.PrcPp.lokasi_id,next_kode_pp).subscribe(p => {
  ...
  reject() {
    ...
    this.PrcPpService.reject(this.PrcPp.id, frmData).subscribe(data => {
      console.log(data);
      // if (data['status'] == 'OK') {
      //   console.log('ok');
      swal({
