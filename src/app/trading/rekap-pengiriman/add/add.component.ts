...
showSuratJalanTervalidasi() {
  const link = window.location.origin + "/#/trading/vsjt";
  ...
  swal({
    title: 'Perhatian!',
    html: `
      Pastikan sudah melakukan <b>Validasi Trading Timbang Customer</b>.<br><br>
      <a href="${link}" target="_blank">
        ➜ Klik untuk buka halaman Validasi Trading Timbang Customer
      </a>
    `,
    type: 'warning',
