...
import { TradingRekapService } from 'src/app/shared/services/trading_rekap.service';

declare var swal: any;
const MenuName = 'trading_rekap';
...
export class ListComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private authenticationService: AuthenticationService,
    ...
    private slsRekapService: TradingRekapService,
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/TradingRekap/list', dataTablesParameters, {})
          .subscribe(resp => {
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.slsRekapService.delete(id).subscribe(data => {
  ...
  edit(id: number) {
    let that = this;
    let pksslsRekap;
    this.slsRekapService.getById(id).subscribe(data => {
      pksslsRekap = data['data'];
  ...
  viewSlip(id) {
    ...
    this.slsRekapService.getPdfSlip(id).subscribe(
      (res) => {
        // console.log(res);
  ...
  posting(id: number) {
    ...
    swal({
      ...
      that.slsRekapService.posting(id, data).subscribe(data => {
