...
const MenuName = 'instruksi_kirim';
...
export class ListComponent implements OnInit {
  ...
  loadDatatable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.http
          .post<DataTablesResponse>(this.apiUrl + '/TradingIntruksi/list/' + this.status, dataTablesParameters, {})
          .subscribe(resp => {
            this.slsIntruksi = resp.data;
  ...
  delete(id: number) {
    ...
    swal({
      ...
      that.slsIntruksiService.delete(id).subscribe(data => {
        // let t = $('#datatables').DataTable().ajax.reload();
        // t.draw();
        that.rerender();
  ...
  edit(id: number) {
    let that = this;
    let slsIntruksi;
    this.slsIntruksiService.getById(id).subscribe(data => {
      slsIntruksi = data['data'];
